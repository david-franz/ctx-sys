...
\begin{enumerate}
    ...
    \item \textbf{Code-aware indexing} using tree-sitter and regex-based AST parsing with automatic relationship extraction across 7 programming languages
...
ctx-sys parses source code into Abstract Syntax Trees, extracting meaningful entities from seven programming languages. Five use tree-sitter for precise parsing; C/C++ and C\# use regex-based extraction to avoid native compilation dependencies:
