...
{`$ npm install -g ctx-sys`}
      ...
      <p>
        Navigate to your project directory and run <code>ctx-sys init</code> to
...
Done in 3.2s`}
      ...
      <p>
        Embeddings are generated by default when Ollama is running. This
        enables vector embeddings for every entity using a local Ollama model,
        unlocking natural-language queries:
      </p>
      <div className="not-prose rounded-xl bg-slate-800 p-5 overflow-x-auto my-4">
        <pre className="m-0 p-0 bg-transparent border-0">
          <code className="text-sm text-slate-50 font-mono">
...
Done in 18.4s`}
      ...
      <div className="not-prose rounded-xl bg-slate-800 p-5 overflow-x-auto my-4">
        <pre className="m-0 p-0 bg-transparent border-0">
          <code className="text-sm text-slate-50 font-mono">
{`$ ctx-sys search "authentication middleware"
