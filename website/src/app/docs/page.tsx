...
export default function DocsPage() {
  return (
    <>
      ...
      <CodeBlock title="Terminal">{`# 1. Install ctx-sys and pull the embedding model
      ...
      <div className="not-prose grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">Research whitepaper and system design documentation</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">Source code, issues, and contributions</p>
          </div>
        </Link>
      </div>
    </>
